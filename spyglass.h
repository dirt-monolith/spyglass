...
#define SPYGLASS_LOG_CFG_USE_FILE_BIT   (1 << 5)
#define SPYGLASS_LOG_CFG_USE_STDERR_BIT (1 << 6)
...
typedef enum
{
    ...
    SPYGLASS_LOG_CFG_USE_FILE   = SPYGLASS_LOG_CFG_USE_FILE_BIT,
    SPYGLASS_LOG_CFG_USE_STDERR = SPYGLASS_LOG_CFG_USE_STDERR_BIT,
    SPYGLASS_LOG_CFG_USE_STDOUT = SPYGLASS_LOG_CFG_USE_STDOUT_BIT,
